...
export default function Home() {
  ...
  return (
    <>
      ...
      <About3
        title="메드웹 소개"
        description="메드웹은 병·의원 전문 홈페이지 제작을 통해 의료 서비스의 가치를 높이는 데 최선을 다하고 있습니다."
        achievementsTitle="메드웹의 성과"
        achievementsDescription="병·의원 홈페이지 제작 전문 기업으로서 축적된 노하우와 실적을 바탕으로 최상의 서비스를 제공합니다."
        achievements={[
          { label: "제작 완료", value: "300+" },
          { label: "진행 프로젝트", value: "50+" },
          { label: "고객 만족도", value: "99%" },
          { label: "수상 경력", value: "10+" },
        ]}
