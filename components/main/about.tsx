  ...
  return (
    <section className="py-32 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid gap-7 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-7 md:flex-row lg:flex-col">
            <div className="flex flex-col justify-between gap-6 rounded-xl bg-gray-50 p-7 md:w-1/2 lg:w-auto">
              ...
              />
              <div>
                <p className="mb-2 text-lg font-semibold text-gray-900">{breakout.title}</p>
        ...
        <div className="py-32">
          <p className="text-center text-gray-700">{companiesTitle} </p>
        ...
        <div className="relative overflow-hidden rounded-xl bg-gray-50 p-10 md:p-16">
          <div className="flex flex-col gap-4 text-center md:text-left">
            <h2 className="text-4xl font-semibold text-gray-900">{achievementsTitle}</h2>
